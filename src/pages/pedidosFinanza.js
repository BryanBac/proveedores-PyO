...
import ModalPedidoRegresar from '@/components/popup/modalPedidoRegresarFinanza'
...
const PedidosFinanza = () => {
    ...
    const filtrarPedidosPorFecha = () => {
        const pedidosFiltrados = dtF.filter(pedido => pedido.fecha === fecha);
    ...
    useEffect(() => {
        if (materiales.length > 0) {
            console.log("Antes", materiales)
        }
    }, [materiales, presionado])
        ...
        <>
            ...
            <div className={styles.inicio}>
                ...
                <div className={styles.contenido}>
                    ...
                    >
                        <ModalPedidoRegresar materiales={materiales} data={dataPresionada} tipo={false} presionado={presionado} setPresionado={setPresionado}></ModalPedidoRegresar>
                    </ModalPopUp>
