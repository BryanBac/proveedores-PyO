...
import PedidosFinanza from './pedidosFinanza';
...
export default function MiniDrawer() {
  ...
  const [option7, setOption7] = React.useState(false);
  ...
  const [dataPresionada, setDataPresionada] = React.useState([])
  ...
  return (
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        {['Perfil'].map((text, index) => (
          <ListItem key={text} disablePadding sx={{ display: 'block' }}>
            ...
            >
              ...
              >
                {index === 0 && <button className={styles.icon} onClick={() => ChangeOptionMenu(index)}><AccountBoxOutlinedIcon/></button>}
               </ListItemIcon>
        ...
        <Divider/>
        <List>
        {['Productos', 'Crear Producto'].map((text, index) => (
          <ListItem key={text} disablePadding sx={{ display: 'block' }}>
            <ListItemButton
              sx={{
                minHeight: 48,
            ...
            >
              ...
              >
                {index === 0 && <button className={styles.icon} onClick={() => ChangeOptionMenu(index+1)}><Inventory2OutlinedIcon /></button>}
                {index === 1 && <button className={styles.icon} onClick={() => ChangeOptionMenu(index+1)}><AddBoxOutlinedIcon /></button>}
                </ListItemIcon>
              <ListItemText primary={text} sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
        ...
        <Divider/>
        <List>
        {['Hacer Pedido', 'Pedidos', 'Pedidos enviados'].map((text, index) => (
          <ListItem key={text} disablePadding sx={{ display: 'block' }}>
            <ListItemButton
              sx={{
                minHeight: 48,
            ...
            >
              ...
              >
                {index === 0 && <button className={styles.icon} onClick={() => ChangeOptionMenu(index+3)}><AddShoppingCartOutlined/></button>}
                {index === 1 && <button className={styles.icon} onClick={() => ChangeOptionMenu(index+3)}><ShoppingCartOutlinedIcon/></button>}
                {index === 2 && <button className={styles.icon} onClick={() => ChangeOptionMenu(index+3)}><ShoppingCartCheckoutRoundedIcon/></button>}
              </ListItemIcon>
              <ListItemText primary={text} sx={{ opacity: open ? 1 : 0 }} />
            </ListItemButton>
          </ListItem>
          ...
          <ListItem key={text} disablePadding sx={{ display: 'block' }}>
            ...
            >
              ...
              >
                {
                index === 0 && 
                <button className={styles.icon} onClick={() => ChangeOptionMenu(index+7)}>
